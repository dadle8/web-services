...
package tk.dadle8.web.services.generated;
 ...
 * generated in the tk.dadle8.web.services.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPersons_QNAME = new QName("http://services.web.dadle8.tk/", "getPersons");
    private final static QName _GetPersonsResponse_QNAME = new QName("http://services.web.dadle8.tk/", "getPersonsResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: tk.dadle8.web.services.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.dadle8.tk/", name = "getPersons")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.web.dadle8.tk/", name = "getPersonsResponse")
