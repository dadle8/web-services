 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://services.web.dadle8.tk/", wsdlLocation = "http://localhost:8080/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://services.web.dadle8.tk/", "PersonService");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://services.web.dadle8.tk/", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.web.dadle8.tk/", "PersonWebServicePort"), PersonWebService.class, features);
    }
